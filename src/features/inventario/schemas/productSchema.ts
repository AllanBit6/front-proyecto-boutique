...
export const variantSchema = z.object({
  ...
  precio_compra: z.number().min(0, "Ingresa un monto válido"),
  precio_venta: z.number().min(0, "Ingresa un monto válido"),
  stock_minimo: z.number().int().min(0, "Ingresa un stock válido"),
})
